...
import { DockIcon, Search, X, MapPin} from "lucide-react";
        ...
        <div className="relative w-full max-w-2xl" ref={searchRef}>
            <form className="relative" onSubmit={handleSubmit}>
                <div className="relative group">
                    <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray/60
                    ...
                    backdrop-blur-xl border border-white/20 rounded-2xl text-white placeholder-white/50
                    ...
                    { query && (
                        <button className="absolute right-14 top-1/2 transform -translate-y-1/2 text-white/50

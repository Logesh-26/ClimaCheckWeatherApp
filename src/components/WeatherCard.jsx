  ...
  return (
    ...
    shadow-2xl hover:bg-white/15 transition-all duration-500'>
          ...
          <div className='flex items-center justify-between mb-8'>
              ...
              <div className='text-right'>
                  ...
                  <div className='text-white/50 text-xs'>
                      {/* Display Dynamic date */ }
                      { new Date(weather.dt * 1000).toLocaleTimeString("en-IN", {
                          hour: "2-digit",
                          minute: "2-digit",
                      })}
                  </div>
          ...
          <div className='grid grid-cols-2 gap-4'>
              <div className='bg-gradient-to-r from-orange-500/20 to-yellow-500/20 backdrop-blur-sm
              rounded-2xl p-4 border border-orange-400/20'>
                  <div className='flex items-center space-x-3 mb-2'>
